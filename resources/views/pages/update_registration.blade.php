...
@section('content')
    ...
    <section id="registration-form">
        <div class="container-fluid redash">
            <h2 class="dash-title">Update Registration Form</h2>
                        ...
                        <input type="hidden" name="_method" value="UPDATE">
                            <div class="row">
                                    <div class="col-lg-6 form-group row mb-0 mb-sm-3">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" id="name" name="name" class="form-control" required value="{{ $registration->name }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 form-group row mb-0 mb-sm-3">
                                    ...
                                    <div class="col-lg-6 form-group row mb-0 mb-sm-3">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" id="no_id" name="no_id" class="form-control" required value="{{ $registration->no_id }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6  form-group row mb-0 mb-sm-3">
                                        <label for="address" class="col-lg-6 col-sm-12 col-form-label text-sm-left">{{_('Address')}}</label>
                                        <div class="col-sm-12">
                                            <input type="text" id="address" name="address" class="form-control" required value="{{ $registration->address }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6  form-group row mb-0 mb-sm-3">
                                        <label for="phone_number" class="col-lg-6 col-sm-12 col-form-label text-sm-left">{{_('Phone Number')}}</label>
                                        <div class="col-sm-12">
                                            <input type="text" id="phone_number" name="phone_number" class="form-control" required value="{{ $registration->phone_number }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 form-group row mb-0 mb-sm-3">
                                        <label for="bank_name" class="col-lg-6 col-sm-12 col-form-label text-sm-left">{{_('Bank Name')}}</label>
                                        <div class="col-sm-12">
                                            <input type="text" id="bank_name" name="bank_name" class="form-control" required value="{{ $registration->bank_name }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 form-group row mb-0 mb-sm-3">
                                        <label for="bankaccount_name" class="col-lg-6 col-sm-12 col-form-label text-sm-left">{{_('Bank Account Name')}}</label>
                                        <div class="col-sm-12">
                                            <input type="text" id="bankaccount_name" name="bankaccount_name" class="form-control" required value="{{ $registration->bankaccount_name }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 form-group row mb-0 mb-sm-3">
                                        <label for="bankaccount_number" class="col-lg-6 col-sm-12 col-form-label text-sm-left">{{_('Bank Account Number')}}</label>
                                        <div class="col-sm-12">
                                            <input type="text" id="bankaccount_number" name="bankaccount_number" class="form-control" required value="{{ $registration->bankaccount_number }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 form-group row mb-0 mb-sm-3">
                                        ...
                                        <div class="trans">
                                        <div class=" col-sm-12">
                                            <input type="file" id="transfer_proof" name="transfer_proof" class="custom-file-input"  value="{{ $registration->transfer_proof }}">
                            ...
                            <div class="form-group row mb-0 sbtn-left">
                                <div class="subbtn col"> {{ method_field('PUT') }}
