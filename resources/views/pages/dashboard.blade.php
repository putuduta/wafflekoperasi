        ...
        <div class="row regis">
            <div class="col-lg-6">
                @if(Auth::user()->role == 'user')
                    <h1 class="regis-title">You can join with waffle now</h1>
                    ...
                    @if(!Auth::guest())
                        @if(Auth::user()->role == 'user')
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                        <tr>
                                            <td class="align-middle text-center">{{ $registration['id'] }}</td>
                                            <td class="align-middle text-center">{{ $registration['name'] }}</td>
                                            <td class="align-middle text-center">{{ $registration['email'] }}</td>
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body mo-res">
                                                                <p>No ID : <span> {{ $registration['no_id'] }}</span></p>
                                                                <p>Address : <span> {{ $registration['address'] }}</span></p>
                                                                <p>Phone Number : <span> {{ $registration['phone_number'] }}</span></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body mo-res">
                                                                <p>Bank Name : <span> {{ $registration['bank_name'] }}</span></p>
                                                                <p>Bank Account Name : <span> {{ $registration['bankaccount_name'] }}</span></p>
                                                                <p>Bank Account Number : <span> {{ $registration['bankaccount_number'] }}</span></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="align-middle text-center">{{ $registration['transfer_proof'] }}</td>
                                            <td class="align-middle text-center">
                                                <a class="btn btn-sm btn-block btn-dark text-white" href="/storage/img/{{ $registration['transfer_proof'] }}">L</a>
                                            </td>
                                        </tr>
                                </tbody>
                            </table>
